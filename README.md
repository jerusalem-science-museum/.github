...
Category prefixes can be mapped to friendly display names via the **organization variable** `EXHIBIT_NAMES` in [GitHub Settings → Secrets and variables → Actions → Variables](https://github.com/organizations/jerusalem-science-museum/settings/variables/actions/EXHIBIT_NAMES).
